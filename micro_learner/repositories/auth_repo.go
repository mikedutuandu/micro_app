...
func (r authRepository) CreateUser(data *micro_learner_pb.User) (primitive.ObjectID,error) {
...
func (r authRepository) GetUserByEmail(email string) (*micro_learner_pb.User,error) {

	// create an empty struct
	data := &micro_learner_pb.User{}
